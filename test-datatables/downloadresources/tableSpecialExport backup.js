...
(function ($) {
  $.fn.specTableExport = function (options) {
    var defaults = {
      csvEnclosure:        '"',
      csvSeparator:        ',',
      csvUseBOM:           true,
      ...
      jspdf: {                          // jsPDF / jsPDF-AutoTable related options
        ...
        autotable: {
          ...
          tableExport: {
            ...
            onTable:           null,
            didDrawPage:       footer_loader,
            BeforePageContent:       header_loader,
            AfterPageContent:       header_loader,
              showHead:     footer_loader,
            outputImages:      true
          }
        }
      },
 ...
 //hidden canvas            
        ...
        loadImages(teOptions, function () {
          $(el).filter(function () {
            ...
            atOptions.margin = chartinfo.doc_margins;
                  ...
                  $.each(all, function () {
                    ...
                    if ( row.height > 0 ) {
                      ...
                      data.table.height += (2 - FONT_ROW_RATIO) / 2 * row.styles.fontSize;
                        console.log( data.table.height+'this is the table height');
                        console.log(row);
                       chartinfo.table_height=data.table.height ;
                    }
                  });
                }
              };
...
//         if ( typeof teOptions.didDrawPage === 'function' )
//              teOptions.didDrawPage($(this), atOptions);
//              
//   if ( typeof teOptions.addPageContent === 'function' )
//              teOptions.addPageContent($(this), atOptions);
