...
describe("Module: html", () => {
  ...
  it("page break with images", async () => {
    const doc = jsPDF({ floatPrecision: 2, unit: "pt", format: [100, 100], lineWidth: 1 });
    await new Promise(resolve =>
      doc.html(
        '<img src="data:images/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8z8DwHwAFBQIAX8jx0gAAAABJRU5ErkJggg==" width="10" height="200">',
        {
          callback: resolve,
          margin: [10, 30, 10, 30]
        }
    ...
    doc.line(0, 50, 100, 50);
    comparePdf(doc.output(), "html-margin-page-break-images.pdf", "html");
  });
