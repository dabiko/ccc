 ...
 *   https://datatables.net/download/#dt/dt-1.13.4/sc-2.1.1/sb-1.4.2/sp-2.1.2
 *
 * Included libraries:
 *   DataTables 1.13.4, Scroller 2.1.1, SearchBuilder 1.4.2, SearchPanes 2.1.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.4/sc-2.1.1/sb-1.4.2/sp-2.1.2",
