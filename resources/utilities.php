...
try {
        ...
        unset($_SESSION['ccc_username']);
        unset($_SESSION['ccc_id']);
...
//        session_regenerate_id(true);
    ...
    return $error;
     ...
     function signcusOut(){
try {
        unset($_SESSION['ccc_cususername']);
        unset($_SESSION['ccc_cusid']);
         unset($_SESSION['ccc_privil']);
        unset($_SESSION['log_id']);
...
//        $values[] = filter_var($email,FILTER_SANITIZE_STRING);
        $_SESSION['ccc_cususername'] = filter_var($name,FILTER_SANITIZE_STRING);
...
$new_security= new security;
      ...
      //columns as Array
       ...
       // $values[] ="";
        $values[] = $username;
        $values[] = filter_var($_POST['name'],FILTER_SANITIZE_STRING);
        $values[] = 1;
        $values[] = $privil;
